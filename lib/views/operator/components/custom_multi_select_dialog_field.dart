...
class CustomMultiSelectDialogField<V> extends FormField<List<V>> {
  ...
  CustomMultiSelectDialogField({
    ...
    this.key,
            ...
            builder: (FormFieldState<List<V>> state) {
              _CustomMultiSelectDialogFieldView<V> field =
                  _CustomMultiSelectDialogFieldView<V>(
                title: title,
                items: items,
              ...
              return _CustomMultiSelectDialogFieldView<V>._withState(
                  field, state);
            });
}

// ignore: must_be_immutable
class _CustomMultiSelectDialogFieldView<V> extends StatefulWidget {
  final MultiSelectListType? listType;
  final BoxDecoration? decoration;
  final Text? buttonText;
  final Icon? buttonIcon;
  ...
  _CustomMultiSelectDialogFieldView({
    required this.items,
    this.title,
    this.buttonText,
    this.buttonIcon,
  ...
  /// This constructor allows a FormFieldState to be passed in. Called by CustomMultiSelectDialogField.
  _CustomMultiSelectDialogFieldView._withState(
      _CustomMultiSelectDialogFieldView<V> field, FormFieldState<List<V>> state)
      : items = field.items,
        title = field.title,
  ...
  @override
  __CustomMultiSelectDialogFieldViewState createState() =>
      __CustomMultiSelectDialogFieldViewState<V>();
}

class __CustomMultiSelectDialogFieldViewState<V>
    extends State<_CustomMultiSelectDialogFieldView<V>> {
